...
```{r ans32}
Gamemaster[[1]][[27]][[4]]
as.numeric(Gamemaster[[1]][[27]][[4]]) -> Pikachu_stats
Pikachu_stats
```
...
Gamemaster[[1]][[731]] <- list(
  ...
  defaultIVs=list(cp1500=c(40,15,15,15),cp2500=c(40,15,15,15))
  )
Gamemaster
```
